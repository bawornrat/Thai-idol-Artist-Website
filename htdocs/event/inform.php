<?php
  ...
  if (isset($_POST['inform'])) {
    ...
    if(empty($_POST['eventdetail'])){
      $sql_insert = "INSERT INTO event (username,eventname, place, lat, lng, start_date, end_date, eventdetail) VALUES ('$username','$_POST[eventname]','$_POST[placeName]','$_POST[lat]','$_POST[lng]','$_POST[start_date]','$_POST[end_date]',null)";
      $result_insert = mysqli_query($conn,$sql_insert);
    }else {
      $sql_insert = "INSERT INTO event (username,eventname, place, lat, lng, start_date, end_date, eventdetail) VALUES ('$username','$_POST[eventname]','$_POST[placeName]','$_POST[lat]','$_POST[lng]','$_POST[start_date]','$_POST[end_date]','$_POST[eventdetail]')";
      $result_insert = mysqli_query($conn,$sql_insert);
    }
...
<body>
      ...
      <div class="container mt-5">
        <h6 class="h6"style="color:red;">* หมายถึง จำเป็นต้องกรอก</h6>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="eventname" placeholder="ชื่อ" onkeyup="enableButton()" name="eventname" required>
                </div>
            </div>
            </div>
            <br>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="placeName" placeholder="ใส่ชื่อสถานที่จัดงาน" onkeyup="enableButton()" name="placeName" required>
                    <br>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="text"  class="form-control" placeholder="Latitude" name="lat" id="lat" readonly required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="lng">Longitude:<span style="color:red;">*</span></label>
                    <input type="text"  class="form-control" placeholder="Longitude" name="lng" id="lng" readonly required>
                    <br>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="date" class="form-control"  name="start_date" onkeyup="enableButton()" id="start_date" required>
                </div>
            </div>
        <br>    
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" placeholder="Longitude" name="end_date" onkeyup="enableButton()" id="end_date" required>
                </div>
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="url" class="form-control" id="eventdetail" placeholder="แนบลิงก์รายละเอียดของงาน" name="eventdetail">
                </div>
            </div>
        </div>
        <br>
    ...
    function enableButton(){
        if(document.getElementById("eventname").value === '' ||document.getElementById("placeName").value === ''){
